    ...
    <Tailwind>
      <Html className="font-sans bg-gray-100">
        ...
        <Body className="bg-white my-10 mx-auto w-full max-w-2xl">
          {/* Header */}
          <Section className="bg-[#27272a] text-foreground px-6 py-4">
          ...
          {shouldDisplayBanner && (
            ...
            >
              <Section>
                <Row>
                  <Column align="left">
                    <Heading className="text-foreground text-xl font-semibold">
                      {email_banner.title}
                    </Heading>
                    <Text className="text-foreground mt-2">{email_banner.body}</Text>
                  </Column>
                  <Column align="right">
                    <Link href={email_banner.url} className="font-semibold px-2 text-foreground underline">
                      Shop Now
                    </Link>
                  </Column>
                </Row>
